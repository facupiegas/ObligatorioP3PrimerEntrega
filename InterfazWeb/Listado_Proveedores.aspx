<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Listado_Proveedores.aspx.cs" Inherits="InterfazWeb.Listado__Proveedores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        &nbsp;</p>
    <p>
        <asp:GridView ID="grdListadoProveedores" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" style="text-align: center" OnSelectedIndexChanged="grdServicios_SelectedIndexChanged">
